...
//    std::cout << (7894771234123413244248_bn / 3478374123412348341_bn) << std::endl;
//    std::cout << (1.0000000000000000000_bn / 5253578741987324_bn) << std::endl;
    std::cout << (1.000000000000000000_bn / 13_bn) << std::endl;
    return 0;
}
